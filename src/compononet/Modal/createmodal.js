...
export default function CreateContacts({isOpen,setIsOpen,onPress}) {
  ...
  return (
    ...
    <div className={className.modal}>
      <div className={`${className.modal_content}`}>
        ...
        >
          <div style={{}}>
            <p className="titleheader" style={{color:"#001044",fontWeight:600}}>Contacts Form</p>
          </div>
          <div
            style={{
              width: "100%",
        ...
        >
          ...
          >
            <p className="headertitle">Create </p>
          </div>
          <div
            style={{
              height: "40px",
          ...
          >
            <p className="headertitle" style={{color:"black",cursor:'pointer'}}>Cancel </p>
          </div>
        </div>
      </div>
    </div>)}</>
